...
class TestSummaryScene(tk.Frame):
    ...
    def create_updated_table(self, parent):
        ...
        self.list_of_completed_tests = [self.data_holder.data_lists['test_completion'][0], self.data_holder.data_lists['test_completion'][1], self.data_holder.data_lists['test_completion'][2], self.data_holder.data_lists['test_completion'][3]]
        self.list_of_pass_fail = [self.data_holder.data_lists['test_results'][0], self.data_holder.data_lists['test_results'][1], self.data_holder.data_lists['test_results'][2], self.data_holder.data_lists['test_results'][3]]
